...
class PublicGetGroupInfoResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["group", "stat", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["group", "stat", ], str]):
