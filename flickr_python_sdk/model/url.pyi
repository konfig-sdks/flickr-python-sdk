...
class URL(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_content", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_content", "type", ], str]):
